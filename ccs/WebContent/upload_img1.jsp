...
<body>
员工管理上传图片
<form id="uploadForm" method="post" enctype="multipart/form-data" action="uploadimg1.action"> 
		   ...
		   <thead>
            ...
            <tbody>
            		...
            		<tr>	
	            		...
	            		<td><img id="fanmian" style="width:350px;height:150px" src="http://47.94.151.107/ccs/image/<%=u.getImgName1()%>" onerror="changeImg('fanmian')"/></td>
	            		<td>
