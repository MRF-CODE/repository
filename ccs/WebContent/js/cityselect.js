...
/* 所有仓库数据,可以按照格式自行添加（北京|beijing|bj），前16条为热门城市 */
...
xmlhttp.onreadystatechange = function(){
	if(xmlhttp.readyState == 4){
		...
		Vcity.allCity = dataArray;
	}
};
xmlhttp.open("post","http://localhost:8080/cms/outputManager/s.action",false);
...
Vcity.CitySelector.prototype = {
    ...
    createWarp:function(){
        ...
        div.style.top = inputPos.bottom +2 + 'px';
